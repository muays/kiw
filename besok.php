...
$baseAuthor = $BRAND;
$URL  =  "https://lppm.stikesgrahaedukasi.ac.id/book/?haha=$BRAND";
$PAGEURL = "https://lppm.stikesgrahaedukasi.ac.id/book/?haha=$BRAND";
$AMP = "https://makassarr.pages.dev/book/?haha=$BRAND";
$DAFTAR = "https://makassarr.pages.dev/book/";
$BANNER = "https://smily.one/nn/retw.jpg";
$LOGO = "https://smily.one/pic/31.png";
$keyword = "$brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🥜 Lembaga Penelitian dan Pengabdian kepada Masyarakat STIKES Graha Edukasi Makassar";
    $DESCRIPTION = "$BRAND merupakan unit pelaksana akademik yang bertanggung jawab dalam mengelola kegiatan penelitian dan pengabdian masyarakat di lingkungan kampus.";
    $description = "$BRAND merupakan unit pelaksana akademik yang bertanggung jawab dalam mengelola kegiatan penelitian dan pengabdian masyarakat di lingkungan kampus.";
}
