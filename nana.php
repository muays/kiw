...
$baseAuthor = $BRAND;
$URL  = "https://disdukcapil.butonkab.go.id/apk/?haha=$BRAND";
$PAGEURL = "https://disdukcapil.butonkab.go.id/apk/?haha=$BRAND";
$AMP = "https://disdukcapil-buton.pages.dev/apk/?haha=$BRAND";
$DAFTAR = "https://disdukcapil-buton.pages.dev/apk/";
$BANNER = "https://smily.one/nn/s5.jpg";
$LOGO = "https://smily.one/pic/31.png";
$keyword = "$brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🥜 Aplikasi Layanan Dinas Kependudukan dan Pencatatan Sipil Kabupaten Buton";
    $DESCRIPTION = "$BRAND masyarakat dapat mengakses informasi dan layanan terkait administrasi kependudukan, seperti pembuatan KTP-el, Kartu Keluarga, akta kelahiran, dan dokumen kependudukan lainnya.";
    $description = "$BRAND masyarakat dapat mengakses informasi dan layanan terkait administrasi kependudukan, seperti pembuatan KTP-el, Kartu Keluarga, akta kelahiran, dan dokumen kependudukan lainnya.";
}
...
<!doctype html>
  ...
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="https://smily.one/pic/2WZwa3l.png" />
  ...
  .n-columns-2 {
    ...
    .login, .login-button {
      background: linear-gradient(to bottom, #e8af02 0%, #e8af02 100%);
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://smily.one/pic/31.png"
